...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/lab-dados/labdados-sdk/blob/main/examples/notebooks/estruturacao.ipynb)

> Versão notebook (rodável no Colab): [`examples/notebooks/estruturacao.ipynb`](https://github.com/lab-dados/labdados-sdk/blob/main/examples/notebooks/estruturacao.ipynb).
