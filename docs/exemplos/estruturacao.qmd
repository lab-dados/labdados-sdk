...
## Receita 3 — Modelo brasileiro self-hosted

`gpt-oss-20b` e `gemma-4-26b-it` rodam em GPU A100 na região Brazil South —
**dados não saem do país**. Útil quando há restrição de soberania.
...
::: {.callout-warning}
Modelos GPU self-host têm **cold start** de ~1min após ociosidade.
A primeira chamada do dia é mais lenta — relaxe enquanto o spinner roda.
:::

## Receita 4 — Local com Ollama
...
## Receita 5 — Local com OpenAI (sua chave)
...
|-----------|---------|--------------|
| `modelo` | `"gpt-4.1-mini"` | `"gpt-oss-20b"` ou `"gemma-4-26b-it"` para soberania |
